...
function projectSiteBottomHTML(project){
  ...
  return '<section class="project-site" data-site-project="'+esc(project.id)+'" data-site-date="'+day.date+'"><div class="section"><b>今日照片</b></div><div class="card"><div class="site-actions"><button class="light" data-site-action="upload">上傳多張照片</button><button class="light" data-site-action="camera">拍照</button></div><input type="file" accept="image/*" multiple data-site-files hidden><input type="file" accept="image/*" capture="environment" data-site-camera hidden><div class="site-photos" data-site-photos>'+projectSitePhotosHTML(day,'',true)+'</div><div data-site-message class="muted" role="status"></div></div><div class="section"><b>產生今日工程日報</b></div><div class="card"><p class="muted">直接帶入今天的現場確認、到場工種、預約事項與照片。</p><button data-site-action="generate">產生今日工程日報</button><div data-site-message class="muted" role="status"></div></div></section>';
}
