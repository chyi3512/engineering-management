...
const VERSION = '20260918-records7';
...
const SHELL = [
  ...
  './css/style.css?v=20260918records7', './css/pwa.css?v=20260910pwa1',
  ...
  './js/daily-report-export.js?v=202609092035', './js/project-site.js?v=20260918records7',
