...
const VERSION = '20260916-swdtimeline1';
...
const SHELL = [
  ...
  './css/style.css?v=20260916buildflow1', './css/pwa.css?v=20260910pwa1',
  ...
  './js/projects.js?v=20260916swdtimeline1', './js/methods.js?v=202609092035',
